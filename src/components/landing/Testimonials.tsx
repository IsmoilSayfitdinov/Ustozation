      ...
      <div className="w-full mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid md:grid-cols-3 gap-5 md:gap-6">
          {items.map((r, idx) => {
            ...
            return (
              <div key={idx} className="bg-white p-5 md:p-8 rounded-2xl border border-outline-variant/20 hover:border-primary/15 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
