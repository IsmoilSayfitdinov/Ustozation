...
import { editLessonSchema, type EditLessonSchema } from '@/schemas/private/admin/lesson';
...
const EditLessonDialog: React.FC<EditLessonDialogProps> = ({ isOpen, onClose, onSubmit, isPending, initialData }) => {
  const { register, handleSubmit, reset, formState: { errors } } = useForm<EditLessonSchema>({
  ...
  const onFormSubmit = (data: EditLessonSchema) => {
